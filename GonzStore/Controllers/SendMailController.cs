...
namespace GonzStore.Controllers
{
    public class SendMailController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var message = new Message(new string[] { mxn.emails }, "[GONZ Store] Mã xác nhận tài khoản",
                "Đây là mã xác nhận của bạn: " + mxn.code);
            ...
            {
                ViewBag.tieude =
                    "Chúng tôi phát hiện bạn đăng nhập từ trình duyệt lạ, do đó chúng tôi đã gửi mã xác nhận về email của bạn. Vui lòng nhập mã xác nhận:";
                ViewBag.type = "1";
            }
            else
            {
        ...
        {
            var message = new Message(new string[] { emails }, "[GONZ Store] Đặt hàng thành công",
                "Đơn hàng của bạn đang được xử lý, bạn có thể dùng mã này để tra cứu trạng thái đơn hàng: " + id);
            _emailsender.SendEmail(message);
